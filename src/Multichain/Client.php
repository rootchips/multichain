...
namespace Chips\Multichain;

use JsonRPC\Client as JsonRPCClient;
/**
 * Class Client
 *
 * @package Multichain\Base
...
class Client
{
    ...
    private $headers = array(
        'User-Agent: Multichain PHP Client',
    );
    ...
    {
        return $this->jsonRPCClient->execute('listaddresses');
    }
    ...
    public function publish($stream, $key, $hex)
    {
        return $this->jsonRPCClient->execute("publish", [$stream, $key, bin2hex($hex)]);
    }

    public function publishFrom($address, $stream, $key, $hex)
    {
